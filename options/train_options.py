...
class TrainOptions():
    ...
    def initialize(self):
        ...
        # parser.add_argument('--attrPath', type=str, default='/home/peiye/transient_scene/annotations/attributes.txt')
        # parser.add_argument('--attrPath', type=str, default='/home/peiye/celeba/attributes.txt')
