...
Usage: 
# face
python train.py --model stylegan_v2 --transform face \
        --num_samples 20000 --learning_rate 1e-4 --latent w \
        --walk_type linear --loss l2 --gpu 0 --overwrite_config --attrList Smiling \
        --attrPath '/home/peiye/celeba/attributes.txt' \
        --models_dir ./models_celeba 
